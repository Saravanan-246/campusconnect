...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const success = await studentLogin(formData.email, formData.password);
      if (success) {
        // Check if user already has a class code from AuthContext
        setTimeout(() => {
    ...
    <div className="min-h-screen w-full bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-slate-100 mb-2">Student Login</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-10 pr-3 py-3 bg-slate-800 border border-slate-700 text-slate-100 rounded-lg px-4 py-2 placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
            ...
            >
              <p className="text-slate-400 text-sm">
                ...
                <a href="/student/signup" className="text-blue-400 hover:text-blue-300 transition-colors">
                  Sign up here
                </a>
              </p>
            </motion.div>
